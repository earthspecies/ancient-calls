...
environment variables. Run from the CLI with ``commoncalls-run --config cfg.yaml``.
"""
...
from commoncalls import call_probability, io, phylogeny, reconstruction, similarity
from commoncalls.config import PipelineConfig
from commoncalls.fit_match_prob import LinkFunction, fit_from_pairs_table
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the common-calls phylogenetic age pipeline.")
